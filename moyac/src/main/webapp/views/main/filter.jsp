			...
			<div class="content_inner">
				<div class="content">
					...
					<div class="content_box">
						...
						<div class="color_box">
							<label class="color btn btn-outline-primary" for="c17">삭제</label>
				...
				<div class="content">
					...
					<div class="content_box">
						...
						<div class="shape_box">
							<label class="shape btn btn-outline-primary" for="s30">삭제</label>
				...
				<div class="content">
					...
					<div class="content_box">
						...
						<div class="formulation_box">
							<label class="formulation btn btn-outline-primary" for="t5">삭제</label>
